...
export const selectPrevCharacters = (state: RootState) => state.characters.previous;
export const selectGetCharactersLoading = (state: RootState) => state.characters.getCharactersLoading;
export const selectGetCharactersError = (state: RootState) => state.characters.getCharactersError;
