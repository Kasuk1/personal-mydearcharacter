...
export const selectGetCharacterDetailLoading = (state: RootState) => state.character.getCharacterDetailLoading;
export const selectGetCharacterDetailError = (state: RootState) => state.character.getCharacterDetailError;
