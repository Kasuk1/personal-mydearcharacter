...
export const selectImageClicked = (state: RootState) => state.layout.imageClicked;
export const selectGetRandomCharacters = (state: RootState) => state.layout.getRandomCharacters;
