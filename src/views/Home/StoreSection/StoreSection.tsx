...
import { getRandomCharacters, selectGetRandomCharacters } from '../../../features/layout/layout.slice';

import StoreSectionStyles from "./StoreSection.styles";

export const StoreSection = () => {
    const dispatch = useAppDispatch();
    const {randomCharacters, getRandomCharactersLoading, getRandomCharactersError} = useAppSelector(selectGetRandomCharacters);
        ...
        <StoreSectionStyles>
            <Container>
                ...
                <div className="store-section--right">
                    {randomCharacters.map(character => <CardDetail key={character.id} {...character} />)}
                </div>
            </Container>
        </StoreSectionStyles>
    )
